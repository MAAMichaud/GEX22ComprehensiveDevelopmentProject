...
std::map<EnemyType, EnemyData> initializeEnemyData()
{
	...
	data[EnemyType::Skeleton].animations[Direction::UpLeft].setDuration(sf::seconds(1.0f));
	data[EnemyType::Skeleton].animations[Direction::UpLeft].setRepeating(true);
	data[EnemyType::Skeleton].speed = sf::seconds(0.8f);
...
std::map<TowerType, TowerData> initializeTowerData()
{
	...
	/*
	std::ifstream ifs("../Media/Textures/TowerAtlasFlipped.json");
	json json_ = json::parse(ifs);
	...
	*/
	...
	data[TowerType::SwordGrandmaster].animations[Direction::Up].addFrameSet(frames.getFramesFor("SwordGrandmaster"));
	...
	data[TowerType::SwordGrandmaster].animations[Direction::UpRight].addFrameSet(frames.getFramesFor("SwordGrandmaster"));
	...
	data[TowerType::SwordGrandmaster].animations[Direction::Right].addFrameSet(frames.getFramesFor("SwordGrandmaster"));
	...
	data[TowerType::SwordGrandmaster].animations[Direction::DownRight].addFrameSet(frames.getFramesFor("SwordGrandmaster"));
	...
	data[TowerType::SwordGrandmaster].animations[Direction::Down].addFrameSet(frames.getFramesFor("SwordGrandmaster"));
	...
	data[TowerType::SwordGrandmaster].animations[Direction::DownLeft].addFrameSet(frames.getFramesFor("SwordGrandmaster"));
	...
	data[TowerType::SwordGrandmaster].animations[Direction::Left].addFrameSet(frames.getFramesFor("SwordGrandmaster"));
	...
	data[TowerType::SwordGrandmaster].animations[Direction::UpLeft].addFrameSet(frames.getFramesFor("SwordGrandmaster"));
	...
	data[TowerType::IceSword].animations[Direction::Up].addFrameSet(frames.getFramesFor("IceSworIceSword"));
