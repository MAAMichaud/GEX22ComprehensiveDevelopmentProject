...
std::map<Projectile::Type, ProjectileData> initializeProjectileData()
{
	...
	data[Projectile::Type::AlliedBullet].speed = 200.f;
	...
	data[Projectile::Type::EnemyBullet].speed = 200.f;
	...
	data[Projectile::Type::Missile].speed = 120.f;
...
std::map<Actor::Type, ActorData> initializeActorData()
{
	...
	JsonFrameParser frames = JsonFrameParser("../Media/Textures/Zombies/hero2.json");
	...
	frames = JsonFrameParser("../Media/Textures/Zombies/zombie1.json");
	...
	frames = JsonFrameParser("../Media/Textures/Zombies/zombie2.json");
	...
	frames = JsonFrameParser("../Media/Textures/Zombies/zombie3.json");
	...
	frames = JsonFrameParser("../Media/Textures/Zombies/zombie4.json");
	...
	frames = JsonFrameParser("../Media/Textures/Zombies/zombie5.json");
